...
class Profile {
    ...
    calculateWidthIntersectOffset(x, y, ang1, ang2, sw = true) {
        var alpha = (PI - ang2 + ang1 + 2 * PI) % (PI);
        var idk = (PI - ang2 + ang1 + 2 * PI) % (2 * PI);
        var c = alpha == idk;
        ...
        var j, theta, xn, yn, gamma, fa, l;
        if (round(idk, 5) != 0 && round(idk, 5) != round(2 * PI, 5)) {
            if (c && !sw) {
                alpha = PI - alpha;
            }
...
class Angled_Profile extends Profile {
    ...
    drawInner() {
        ...
        var off_outer = this.calculateWidthIntersectOffset(outer_widths[0], outer_widths[1], -this.parts[0].angle, swVal - this.parts[1].angle, false)
        var off_inner = this.calculateWidthIntersectOffset(inner_widths[0], inner_widths[1], -this.parts[0].angle, swVal - this.parts[1].angle, false)
...
class T_Profile extends Profile {
    ...
    drawInner() {
        ...
        if (this.parts[0].isOuter || this.parts[1].isOuter || this.parts[2].isOuter) {
            ...
            // LEFT
            off = this.calculateWidthIntersectOffset(inner_widths[1], inner_widths[0], -this.parts[1].angle, PI - this.parts[0].angle, false)
            ...
            // RIGHT
            off = this.calculateWidthIntersectOffset(inner_widths[0], inner_widths[2], this.parts[0].angle, this.parts[2].angle, false)
            ...
            // TOP
            off = this.calculateWidthIntersectOffset(outer_widths[1], outer_widths[2], this.parts[2].angle, PI - this.parts[1].angle, false)
            ...
            // Side 2
            off = this.calculateWidthIntersectOffset(inner_widths[0], inner_widths[1], this.parts[0].angle, this.parts[1].angle, false)
            ...
            // Side 3
            off = this.calculateWidthIntersectOffset(inner_widths[1], inner_widths[2], this.parts[1].angle, this.parts[2].angle, false)
    ...
    draw3D() {
        ...
        if (this.parts[0].isOuter || this.parts[1].isOuter || this.parts[2].isOuter) {
            ...
            // LEFT
            var off1 = this.calculateWidthIntersectOffset(inner_widths[1], inner_widths[0], -this.parts[1].angle, PI - this.parts[0].angle, false)
            ...
            // RIGHT
            var off2 = this.calculateWidthIntersectOffset(inner_widths[0], inner_widths[2], this.parts[0].angle, this.parts[2].angle, false)
            ...
            //TOP
            var off3 = this.calculateWidthIntersectOffset(outer_widths[1], outer_widths[2], this.parts[2].angle, PI - this.parts[1].angle, false)
            ...
            // Side 1
            var off1 = this.calculateWidthIntersectOffset(inner_widths[0], inner_widths[2], this.parts[0].angle, this.parts[2].angle, false)
            ...
            // Side 2
            var off2 = this.calculateWidthIntersectOffset(inner_widths[0], inner_widths[1], this.parts[0].angle, this.parts[1].angle, false)
            ...
            //Side 3
            var off3 = this.calculateWidthIntersectOffset(inner_widths[1], inner_widths[2], this.parts[1].angle, this.parts[2].angle, false)
